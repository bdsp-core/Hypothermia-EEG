...
for fileNo=[1 3 7 100] %[1 2 3 4 5 7 8 10 12 13 14];
    ...
    cd(td); 
    load(sprintf('WarmCold%d',fileNo)); 
    cd(pd); 
    ...
    ylabel('Normalized power (dB)','fontsize',14,'fontname','arial');
    set(gca,'tickdir','out');
    box off
    ...
    h=text(20,-5,'15-20 \circC'); set(h,'fontname','arial','fontsize',15);
    set(h,'color','b')
    h=text(20,-10,'25-30 \circC'); set(h,'fontname','arial','fontsize',15)
    set(h,'color','r')
    ...
    eval(['print -dpng -r300 Fig_WarmColdSpectra' num2str(fileNo) '.png']);
